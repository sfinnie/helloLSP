 ...
 * The final patters - `\s*$` - means match zero or more whitespace characters before the end of the line.  Again, `\s` means match a single whitespace character; `*` means match zero or more; and `$` means match the end of the string.
